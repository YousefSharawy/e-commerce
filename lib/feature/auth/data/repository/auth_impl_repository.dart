...
class AuthImplRepository implements AuthRepository{
  ...
  @override
  Future<Either<Failure, void>> registerAsUser(String email, String name, String password) async {
     try {
  ...
  @override
  Future<Either<Failure, void>> registerAsVendor(String email, String name, String password) async {
     try {
